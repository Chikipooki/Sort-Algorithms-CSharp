...
В информатике <b>алгоритм сортировки</b> называется - алгоритмом, который упорядочивает элементы в списке. 
...
.1. Сортируемый массив разбивается на две части примерно одинакового размера;<br>
.2. Каждая из получившихся частей сортируется отдельно, например — тем же самым алгоритмом;<br>
